...
PPTX 自動生成に特化した 5 エージェント体制:

```
orchestrator.agent.md  # オーケストレーター（指揮のみ）
template.agent.md      # テンプレート選定・構造解析
content.agent.md       # コンテンツ作成・JSON 生成
builder.agent.md       # PPTX 生成コマンド実行
reviewer.agent.md      # 中間 + 最終の 2 段階レビュー
```
